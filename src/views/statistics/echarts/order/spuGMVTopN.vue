...
export default {
  ...
  methods: {
    ...
    init() {
      this.getParent()
      api.getSpuGMVData(this.recentDays,this.showNum,this.curDate).then(response => {
    ...
    visualMap: {
      ...
      var myChart = echarts.init(document.getElementById('spuGMVChart'))
