<template>
      ...
      <div id="spuChart" style="width:100%;height:340px;" />
...
export default {
  ...
  methods: {
    ...
    init() {
      this.getParent()
      api.getSpuTopNData(this.recentDays,this.showNum,this.curDate).then(response => {
    ...
    series: [{
     ...
     visualMap: {
      ...
      var myChart = echarts.init(document.getElementById('spuChart'))
