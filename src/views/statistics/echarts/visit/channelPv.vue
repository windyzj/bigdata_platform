<template>
      ...
      <div id="chartChanelPv" style="width:100%;height:340px;" />
...
export default {
  ...
  methods: {
    ...
    init() {
      this.getParent()
      api.getChannelPvData(this.recentDays,this.curDate).then(response => {
    ...
    series: [{
      ...
      var myChart = echarts.init(document.getElementById('chartChanelPv'))
